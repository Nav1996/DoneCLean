...
public class CleanerCreation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       emdb  = new EmployeesManagementDbHelper(this); //dbhelper to use for connecting to db
        ...
        setContentView(R.layout.content_cleaner_creation);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);

        Intent intent = getIntent();
        final long departmentId = intent.getExtras().getLong("departmentId");
        final String depId = intent.getExtras().getString("depId");
        ...
        date_select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // date picker dialog
                picker = new DatePickerDialog(CleanerCreation.this,
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if (matchFields()!= 5)
                    ...
                    if (emdb.addEmployee(employee_name.getText().toString(), date_select.getText().toString(), depId ,departmentId, employee_job.getText().toString(), employee_email.getText().toString(), employee_phone.getText().toString(), null)) {
