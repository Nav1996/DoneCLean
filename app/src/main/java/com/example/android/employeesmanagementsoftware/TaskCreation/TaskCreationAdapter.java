...
public class TaskCreationAdapter extends CursorAdapter {
    ...
    public void bindView(final View view, final Context context, final Cursor cursor) {
        ...
        final String employeeName = cursor.getString(cursor.getColumnIndexOrThrow(CleanerContract.EmployeeEntry.COLUMN_EMPLOYEE_NAME));
        final long ID = cursor.getLong(cursor.getColumnIndex(CleanerContract.EmployeeEntry._ID));
