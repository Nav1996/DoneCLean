    ...
    class SpinnerInitTask extends AsyncTask<SpinnerTaskParams,Void,SpinnerTaskParams>{
        ...
        protected void onPostExecute(final SpinnerTaskParams spinnerTaskParams) {
            ...
            SimpleCursorAdapter adapter = new SimpleCursorAdapter(
                    ...
                    new String[]{SiteContract.DepartmentEntry.COLUMN_DEPARTMENT_NAME},
            ...
            spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    initListView(spinnerTaskParams.getCursor().getLong(spinnerTaskParams.getCursor().getColumnIndex(SiteContract.
                                    DepartmentEntry._ID))
